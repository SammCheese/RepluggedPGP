...
const patches: types.PlaintextPatch[] = [
  {
    replacements: [
      ...
      },
      {
        ...
        replace: `$&,($3.content.match("-----BEGIN"))?$1({key:"pgp-decrypt",label:"PGP Actions",icon:window.RPGP.popoverIcon,channel:$2,message:$3,onClick:()=>window.RPGP.receiver($3)}):null`,
      },
    ],
  },
];
