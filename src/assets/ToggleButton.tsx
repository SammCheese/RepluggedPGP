...
import { buildToggleModal } from "../components/ToggleModal";

const { Clickable, Tooltip } = components;

export const PGPToggleButton = (
  <Tooltip text="Toggle PGP Options">
    <Clickable style={{ marginTop: 12, marginRight: 5, marginLeft: 5 }}>
      <svg
        key="Toggle PGP"
